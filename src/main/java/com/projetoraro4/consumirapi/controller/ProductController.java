...
public class ProductController {
    ...
    @PostMapping
    public ResponseEntity<List<ProductResponseDTO>> getProduct(@Valid @RequestBody ProductRequestDTO request) {
        List<ProductResponseDTO> products = productService.getProduct(request);
        return ResponseEntity.ok(products);
    }
